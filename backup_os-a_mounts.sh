...
# original file location: ~/scripts/backup_os-a_mounts.sh

# Make sure we're not running as root
test "$UID" -ne "0" || exit "$(false || echo "$?")" 

# Mount points and UUIDs
readonly mount_dir="/mnt/tedlibuilt"
readonly root_disk_uuid="7db26808-7757-4457-aefe-c211e3a0a5da"
readonly home_disk_uuid="31ce0ffd-15c5-46a8-b719-00a4bf1658fd"
readonly efi_part_uuid="B147-5862"
